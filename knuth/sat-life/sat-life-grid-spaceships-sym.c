...
#line 22 "./sat-life-grid-spaceships-sym.ch"
int tt;
int mm,nn,r,s;
#line 103 "./sat-life.w"
int xmax,ymax;
...
k= (clause[p]>>25)&0x7;
x= (clause[p]>>12)&0xfff;
#line 83 "./sat-life-grid-spaceships-sym.ch"
y= clause[p]&0xfff;
...
#line 89 "./sat-life-grid-spaceships-sym.ch"
if(k==0&&pp(x,y)==0)
#line 218 "./sat-life.w"
...
#line 94 "./sat-life-grid-spaceships-sym.ch"
/*:15*/
#line 112 "./sat-life.w"
...
#line 56 "./sat-life-grid-spaceships-sym.ch"
...
#line 115 "./sat-life.w"
;
#line 33 "./sat-life-grid-spaceships-sym.ch"
for(tt= 0;tt<r;tt++){
ymax= nn,ymin= 1;
xmax= mm,xmin= 1;
for(x= xmin-1;x<=xmax+1;x++)for(y= ymin-1;y+y<=ymax+1;y++){
/*5:*/
#line 75 "./sat-life-grid-spaceships-sym.ch"
...
/*:5*/
#line 37 "./sat-life-grid-spaceships-sym.ch"
;
a(x,y);
zprime(x,y);
...
/*16:*/
#line 97 "./sat-life-grid-spaceships-sym.ch"
...
/*:16*/
#line 44 "./sat-life-grid-spaceships-sym.ch"
;
#line 122 "./sat-life.w"
}
