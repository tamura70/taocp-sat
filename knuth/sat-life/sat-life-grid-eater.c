...
#line 24 "./sat-life-grid-eater.ch"
int tt;
int mm,nn,r;
#line 103 "./sat-life.w"
int xmax,ymax;
...
#line 84 "./sat-life-grid-eater.ch"
if(k==0&&pp(x,y)==0)
#line 218 "./sat-life.w"
...
#line 89 "./sat-life-grid-eater.ch"
/*:15*/
#line 112 "./sat-life.w"
...
#line 58 "./sat-life-grid-eater.ch"
...
#line 115 "./sat-life.w"
;
#line 35 "./sat-life-grid-eater.ch"
for(tt= 0;tt<r;tt++){
ymax= nn,ymin= 1;
xmax= mm,xmin= 1;
for(x= xmin-1;x<=xmax+1;x++)for(y= ymin-1;y<=ymax+1;y++){
/*5:*/
#line 76 "./sat-life-grid-eater.ch"
...
/*:5*/
#line 39 "./sat-life-grid-eater.ch"
;
a(x,y);
zprime(x,y);
...
/*17:*/
#line 94 "./sat-life-grid-eater.ch"
...
/*:17*/
#line 90 "./sat-life-grid-eater.ch"
;
/*18:*/
#line 114 "./sat-life-grid-eater.ch"
...
/*:18*/
#line 91 "./sat-life-grid-eater.ch"
;
/*19:*/
#line 127 "./sat-life-grid-eater.ch"
...
/*:19*/
#line 92 "./sat-life-grid-eater.ch"
;

/*:16*/
#line 46 "./sat-life-grid-eater.ch"
;
#line 122 "./sat-life.w"
}
