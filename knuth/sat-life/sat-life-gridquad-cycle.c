...
#line 24 "./sat-life-gridquad-cycle.ch"
int tt;
int mm,nn,r;
#line 103 "./sat-life.w"
int xmax,ymax;
...
void outclause(void){
#line 84 "./sat-life-gridquad-cycle.ch"
...
k= (clause[p]>>25)&0x7;
x= (clause[p]>>12)&0xfff;
#line 89 "./sat-life-gridquad-cycle.ch"
y= clause[p]&0xfff;
if(c==0){
...
#line 98 "./sat-life-gridquad-cycle.ch"
x,timecode[(tt+k)%r],y);
#line 208 "./sat-life.w"
}
printf("\n");
...
#line 103 "./sat-life-gridquad-cycle.ch"
if(k==0&&pp(x,y)==0)
#line 218 "./sat-life.w"
...
#line 108 "./sat-life-gridquad-cycle.ch"
/*:15*/
#line 112 "./sat-life.w"
...
#line 58 "./sat-life-gridquad-cycle.ch"
...
#line 115 "./sat-life.w"
;
#line 35 "./sat-life-gridquad-cycle.ch"
for(tt= 0;tt<r;tt++){
ymax= nn,ymin= 1;
xmax= mm,xmin= 1;
for(x= 0;x+x<=mm+1;x++)for(y= 0;y+y<=nn+1;y++){
/*5:*/
#line 76 "./sat-life-gridquad-cycle.ch"
...
/*:5*/
#line 39 "./sat-life-gridquad-cycle.ch"
;
a(x,y);
zprime(x,y);
if(pp(x,y)==0)
...
/*16:*/
#line 110 "./sat-life-gridquad-cycle.ch"
...
/*:16*/
#line 46 "./sat-life-gridquad-cycle.ch"
;
#line 122 "./sat-life.w"
}
