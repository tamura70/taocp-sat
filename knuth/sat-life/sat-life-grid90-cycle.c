...
#line 22 "./sat-life-grid90-cycle.ch"
int tt;
int mm,nn,r;
#line 103 "./sat-life.w"
int xmax,ymax;
...
void outclause(void){
#line 86 "./sat-life-grid90-cycle.ch"
...
k= (clause[p]>>25)&0x7;
x= (clause[p]>>12)&0xfff;
#line 91 "./sat-life-grid90-cycle.ch"
y= clause[p]&0xfff;
...
#line 97 "./sat-life-grid90-cycle.ch"
x,timecode[(tt+k)%r],y);
#line 208 "./sat-life.w"
}
printf("\n");
...
#line 102 "./sat-life-grid90-cycle.ch"
if(k==0&&pp(x,y)==0)
#line 218 "./sat-life.w"
...
#line 107 "./sat-life-grid90-cycle.ch"
/*:15*/
#line 112 "./sat-life.w"
...
#line 56 "./sat-life-grid90-cycle.ch"
...
#line 115 "./sat-life.w"
;
#line 33 "./sat-life-grid90-cycle.ch"
for(tt= 0;tt<r;tt++){
ymax= nn,ymin= 1;
xmax= mm,xmin= 1;
for(x= 0;x+x<=nn+1;x++)for(y= x;y+x<=nn+(x==y);y++){
/*5:*/
#line 78 "./sat-life-grid90-cycle.ch"
...
/*:5*/
#line 37 "./sat-life-grid90-cycle.ch"
;
a(x,y);
zprime(x,y);
if(pp(x,y)==0)
...
/*16:*/
#line 109 "./sat-life-grid90-cycle.ch"
...
/*:16*/
#line 44 "./sat-life-grid90-cycle.ch"
;
#line 122 "./sat-life.w"
}
