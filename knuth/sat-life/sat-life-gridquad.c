...
#line 115 "./sat-life.w"
;
#line 34 "./sat-life-gridquad.ch"
for(tt= 0;tt<r;tt++){
ymax= nn,ymin= 1;
xmax= mm,xmin= 1;
for(x= 0;x+x<=mm+1;x++)for(y= 0;y+y<=nn+1;y++){
/*5:*/
#line 74 "./sat-life-gridquad.ch"
