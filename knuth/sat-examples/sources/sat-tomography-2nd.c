...
#include <stdio.h> 
#include <stdlib.h> 
#line 14 "./sat-tomography-2nd.ch"
int r[mmax+1],c[mmax+1],a[mmax+nmax],b[mmax+nmax];
int rr[mmax+1],cc[mmax+1],aa[mmax+nmax],bb[mmax+nmax];
#line 21 "./sat-tomography.w"
...
;
main(){
#line 20 "./sat-tomography-2nd.ch"
register int d,i,j,k,l,ll,m,n,nn,t;
#line 27 "./sat-tomography.w"
register char*p;
/*2:*/
...
#line 36 "./sat-tomography-2nd.ch"
r[d]= l,rr[d]= ll;
#line 75 "./sat-tomography.w"
break;
...
#line 41 "./sat-tomography-2nd.ch"
c[d]= l,cc[d]= ll;
#line 95 "./sat-tomography.w"
break;
...
#line 46 "./sat-tomography-2nd.ch"
a[d]= l,aa[d]= ll;
#line 114 "./sat-tomography.w"
break;
...
#line 51 "./sat-tomography-2nd.ch"
b[d]= l,bb[d]= ll;
#line 133 "./sat-tomography.w"
break;
...
nn);
#line 56 "./sat-tomography-2nd.ch"
printf("~ sat-tomography-2nd (%dx%d, %d)\n",
#line 165 "./sat-tomography.w"
m,n,nn);
...
#line 61 "./sat-tomography-2nd.ch"
gen_clauses(n,r[i]);
gen_clauses1(n-1,rr[i]);
#line 189 "./sat-tomography.w"
}
