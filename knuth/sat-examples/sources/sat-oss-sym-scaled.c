...
#line 10 "./sat-oss-sym-scaled.ch"
register int i,j,ii,jj,k,l,reflectionsymmetryused= 0;
#line 31 "./sat-oss.w"
/*2:*/
#line 37 "./sat-oss.w"

#line 19 "./sat-oss-sym-scaled.ch"
if(argc!=5||
sscanf(argv[1],"%d",&m)!=1||
sscanf(argv[2],"%d",&n)!=1||
sscanf(argv[3],"%d",&t)!=1||
