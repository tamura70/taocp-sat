...
/*:8*//*13:*/
#line 33 "./sat-chains-lex-1234.ch"
...
#line 5 "./sat-chains-lex-1234.ch"
if(n<4||n> maxn){
fprintf(stderr,"n should be between 4 and %d, not %d!\n",maxn,n);
#line 59 "./sat-chains.w"
exit(-2);
}
if(n+r> maxk){
...
#line 11 "./sat-chains-lex-1234.ch"
printf("~ sat-chains-lex-1234 %d %d",n,r);
#line 86 "./sat-chains.w"
...
;
#line 16 "./sat-chains-lex-1234.ch"
/*6:*/
...
;
/*14:*/
#line 44 "./sat-chains-lex-1234.ch"
...
/*:14*/
#line 17 "./sat-chains-lex-1234.ch"
;
...
{
#line 22 "./sat-chains-lex-1234.ch"
breaksym(k,j,i,2,1);
breaksym(k,j,i,3,2);
breaksym(k,j,i,4,3);
for(h= 1;h<(1<<n);h++){
#line 141 "./sat-chains.w"
...
#line 30 "./sat-chains-lex-1234.ch"
/*:12*/
