...
#line 12 "./sat-queens-color-order-organpipe.ch"
if(argc!=3||sscanf(argv[1],"%d",&n)!=1
||sscanf(argv[2],"%d",&d)!=1){
fprintf(stderr,"Usage: %s n d\n",argv[0]);
#line 32 "./sat-queens-color-order-cliques2.w"
exit(-1);
}
if(d<n){
...
#line 27 "./sat-queens-color-order-organpipe.ch"
...
;
/*3:*/
#line 29 "./sat-queens-color-order-organpipe.ch"

for(i= 0,j= d-1;i<j;i++,j--)
perm[i]= i+i,perm[j]= i+i+1;
if(i==j)perm[i]= i+i;
#line 51 "./sat-queens-color-order-cliques2.w"
printf("~");
