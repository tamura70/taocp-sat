...
#line 57 "./sat-mutex-starve.ch"
/*:19*/
#line 51 "./sat-mutex-starve.ch"
;
}
...
#line 87 "./sat-mutex.w"
;
#line 26 "./sat-mutex-starve.ch"
/*25:*/
#line 77 "./sat-mutex-starve.ch"

for(j= pp;j<r;j++)printf(" ~%03d@",j);
printf("\n");
for(j= pp;j<r;j++)printf(" %03d@",j);
printf("\n");
