...
#define xbar(k) printf("~%s.%d",(g->vertices+(k) -n+1) ->name,kk)  \
...
#include <stdio.h> 
#include <stdlib.h> 
#line 11 "./sat-threshold-bb-graphs.ch"
#include "gb_graph.h"
#include "gb_save.h"
int n,r,kk;
...
#line 18 "./sat-threshold-bb-graphs.ch"
...
#line 27 "./sat-threshold-bb-graphs.ch"
