...
#line 21 "./sat-mutex-distinct-lemmas.ch"
int r;
FILE*lemma_file;
#line 80 "./sat-mutex.w"
char buf[bufsize];
...
#line 84 "./sat-mutex.w"
;
#line 33 "./sat-mutex-distinct-lemmas.ch"
t= -1;
/*18:*/
...
/*:18*/
#line 34 "./sat-mutex-distinct-lemmas.ch"
;
/*19:*/
...
/*:19*/
#line 35 "./sat-mutex-distinct-lemmas.ch"
;
for(t= 0;t<r;t++){
register int u;
/*17:*/
...
#line 71 "./sat-mutex-distinct-lemmas.ch"
if(0)
...
#line 91 "./sat-mutex-distinct-lemmas.ch"
...
#line 88 "./sat-mutex-distinct-lemmas.ch"
/*:20*/
...
#line 122 "./sat-mutex-distinct-lemmas.ch"
if(0)
...
#line 139 "./sat-mutex-distinct-lemmas.ch"
...
/*:17*/
#line 38 "./sat-mutex-distinct-lemmas.ch"
;
for(u= 0;u<=t;u++)
/*26:*/
#line 174 "./sat-mutex-distinct-lemmas.ch"
...
/*:26*/
#line 40 "./sat-mutex-distinct-lemmas.ch"
;
}
/*27:*/
#line 197 "./sat-mutex-distinct-lemmas.ch"
...
for(t= 0;t<=r;t++)
/*28:*/
#line 207 "./sat-mutex-distinct-lemmas.ch"
...
/*:28*/
#line 203 "./sat-mutex-distinct-lemmas.ch"
;
}
fprintf(stderr,"(%d lemmas satisfactorily read and appended)\n",i-1);

/*:27*/
#line 42 "./sat-mutex-distinct-lemmas.ch"
;
#line 89 "./sat-mutex.w"
}
